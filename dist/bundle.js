...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["d"] = isInformoConnected;
/* harmony export (immutable) */ __webpack_exports__["a"] = getConnectedMatrixClient;
/* harmony export (immutable) */ __webpack_exports__["b"] = getNews;
/* harmony export (immutable) */ __webpack_exports__["c"] = getSingleArticle;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__storage__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sources__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__matrix_client__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_materialize_css__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_canonical_json__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_canonical_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_canonical_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_tweetnacl__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_tweetnacl___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_tweetnacl__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_tweetnacl_util__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_tweetnacl_util___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_tweetnacl_util__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_sidebar__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__article__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__database__ = __webpack_require__(9);
...
function connectingToastStart(){
	connectingToast = __WEBPACK_IMPORTED_MODULE_4_materialize_css___default.a.toast(__WEBPACK_IMPORTED_MODULE_3_jquery___default()(`
...
function connectingToastSetContent(html){
	...
	__WEBPACK_IMPORTED_MODULE_3_jquery___default()(connectingToast.el).find(".toast-text").html(html);
}

function connectingToastEnd(html, success){
	connectingToastSetContent(html);
	__WEBPACK_IMPORTED_MODULE_3_jquery___default()(connectingToast.el).addClass(success === true ? "informo-bg-green" : "red darken-3");
	__WEBPACK_IMPORTED_MODULE_3_jquery___default()(connectingToast.el).find(".preloader-wrapper").hide();
...
function getConnectedMatrixClient(){
	...
	if(isConnected === false || mxClient === null || __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL !== currentHomeserverURL){
		...
		connectingToastSetContent("Connecting to <code>" + __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL + " " + __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomAlias + "</code>");
		...
		pendingConnectionPromise = new Promise((resolve, reject) => {
			...
			let matrixClientPromise = new Promise((resolve, reject) => {
				...
				if(__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL === null
				|| __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].accessToken === null
				|| (currentHomeserverURL !== null && __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL !== currentHomeserverURL)){

					console.info("Registering as guest");
					connectingToastSetContent("Registering as guest on <code>" + __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL + "</code>");

					// Resolve to a matrix client on query completion
					return resolve(__WEBPACK_IMPORTED_MODULE_2__matrix_client__["a" /* default */].registerGuest(__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL));
				}

				console.info("Reusing guest account ", __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].userID);

				// Resolve to a matrix client now
				resolve(new __WEBPACK_IMPORTED_MODULE_2__matrix_client__["a" /* default */](
					__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL,
					__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].accessToken,
					__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].userID,
					__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].deviceID
				));
			});
			...
			matrixClientPromise
				.then((client) => {
					...
					__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL = client.homeserverURL;
					__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].accessToken = client.accessToken;
					__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].userID = client.userID;
					__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].deviceID = client.deviceID;
					__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].save();

					// Save matrix client object
					mxClient = client;
					currentHomeserverURL = __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL;

					// Update sidebar information
					__WEBPACK_IMPORTED_MODULE_8__pages_sidebar__["c" /* updateState */]();

					return mxClient;
				},
				(err) => {
					pendingConnectionPromise = null;
					connectingToastEnd("Could not connect to <code>" + __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL + "</code>", false);
					throw err;
				})
				...
				.then(() => {
					connectingToastEnd("Connected to Informo through <code>" + __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].homeserverURL + "</code>", true);
				},
				(err) => {
					pendingConnectionPromise = null;
...
function _loadInformo() {
	return new Promise((resolve, reject) => {
		...
		let roomIDPromise;
		if(__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomID === null){
			connectingToastSetContent("Searching Informo room <code>"+__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomAlias+"</code>");
			roomIDPromise = mxClient.getRoomIDForAlias(__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomAlias);
		}
		else{
			roomIDPromise = new Promise((resolve, reject) => {
				resolve(__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomID);
			});
		}
		...
		roomIDPromise
			...
			.then((roomID) => {
				__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomID = roomID;
				__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].save();

				connectingToastSetContent("Check if joined Informo room <code>"+__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomAlias+"</code>");
			...
			.then((rooms) => {
				...
				for(let room of rooms) {
					if(room === __WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomID) {
						inRoom = true;
					}
				}
				...
				connectingToastSetContent("Joining Informo room <code>"+__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomAlias+"</code>");
				return mxClient.joinRoom(__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomAlias);
			})
			// Retrieve source list
			.then(() => {
				connectingToastSetContent("Fetching Informo source list");
				return mxClient.getStateEvent(__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomID, "network.informo.sources");
			})
			// Store source list
			.then((sources) => {
				__WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].setSources(sources);
				if(!__WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].hasSources()) {
...
function getNews(sourceClassNames, resetPos = false) {
	...
	if(sourceClassNames.length === 1 &&  sourceClassNames[0] === "*"){
		//Fetch everything
		for(let className in __WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].sources) {
			filter.types.push(className);
			for(let publisher of __WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].sources[className].publishers) {
		...
		for(let className of sourceClassNames) {
			if(__WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].sources[className]){
				filter.types.push(className);
				for(let publisher of __WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].sources[className].publishers) {
					filter.senders.push(publisher);
				}
	...
	return getConnectedMatrixClient()
		.then((client) => {
			matrixClient = client;
			return matrixClient.getMessages(__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomID, filter, 20, resetPos);
		})
		.then((events) => {
			let promises = [];
...
function getSingleArticle(eventID) {
	let matrixClient = null;
	...
	return getConnectedMatrixClient()
		.then((client) => {
			matrixClient = client;
			return matrixClient.getMessage(__WEBPACK_IMPORTED_MODULE_0__storage__["a" /* default */].roomID, eventID);
		})
		.then((event) => {
...
function matrixEventToArticle(matrixEvent){
	return new Promise((resolve, reject) => {
		...
		getConnectedMatrixClient()
			.then(() => {
				article = new __WEBPACK_IMPORTED_MODULE_9__article__["a" /* Article */](
					...
					__WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].sources[matrixEvent.type].name,
					matrixEvent.content.date,
					matrixEvent.content.content,
					matrixEvent.content.link,
					__WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].canPublish(matrixEvent.sender, matrixEvent.type)
				);

				return __WEBPACK_IMPORTED_MODULE_10__database__["a" /* default */].getArticleRead(article.id);
			})
			.then((isRead) => {
				...
				let key, canonical;
				try {
					article.signature = __WEBPACK_IMPORTED_MODULE_7_tweetnacl_util__["decodeBase64"](matrixEvent.content.signature);
					key = __WEBPACK_IMPORTED_MODULE_7_tweetnacl_util__["decodeBase64"](__WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].sources[matrixEvent.type].publicKey);
					canonical = __WEBPACK_IMPORTED_MODULE_7_tweetnacl_util__["decodeUTF8"](__WEBPACK_IMPORTED_MODULE_5_canonical_json___default()(matrixEvent.content));
				} catch(e) {
					return false;
				}

				return __WEBPACK_IMPORTED_MODULE_6_tweetnacl__["sign"].detached.verify(canonical, article.signature, key);
			})
			.then((signatureOk) => {
...
/* harmony default export */ __webpack_exports__["a"] = (new Sources);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = stripNewsEventPrefix;
...
const newsEventPrefix = "network.informo.news.";
/* harmony export (immutable) */ __webpack_exports__["a"] = newsEventPrefix;


function stripNewsEventPrefix(newsEventClassName){
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_connect__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_feeds__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_source__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_discover__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_sidebar__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_article__ = __webpack_require__(32);
// Copyright 2017 Informo core team <core@informo.network>
//
// Licensed under the GNU Affero General Public License, Version 3.0
// (the "License"); you may not use this file except in compliance with the
...
const routes = [
	{
		path: "/connect",
		elmt: "#page-connect",
		onInit: __WEBPACK_IMPORTED_MODULE_1__pages_connect__["a" /* init */],
		onRemoved: null,
	},
	{
		path: "/feeds/all",
		elmt: "#page-feeds",
		onInit: () => { __WEBPACK_IMPORTED_MODULE_2__pages_feeds__["a" /* init */]("all"); },
		onRemoved: __WEBPACK_IMPORTED_MODULE_2__pages_feeds__["b" /* remove */],
	},
	{
		path: "/feeds/source/:sourceName",
		elmt: "#page-feeds",
		onInit: () => { __WEBPACK_IMPORTED_MODULE_2__pages_feeds__["a" /* init */]("source"); },
		onRemoved: __WEBPACK_IMPORTED_MODULE_2__pages_feeds__["b" /* remove */],
	},
	{
		path: "/source/:sourceName",
		elmt: "#page-source",
		onInit: __WEBPACK_IMPORTED_MODULE_3__pages_source__["a" /* init */],
		onRemoved: __WEBPACK_IMPORTED_MODULE_3__pages_source__["b" /* remove */],
	},
	{
		path: "/discover",
		elmt: "#page-discover",
		onInit: __WEBPACK_IMPORTED_MODULE_4__pages_discover__["a" /* init */],
		onRemoved: null,
	},
	{
		path: "/article/:eventID",
		elmt: "#page-article",
		onInit: __WEBPACK_IMPORTED_MODULE_6__pages_article__["a" /* init */],
		onRemoved: __WEBPACK_IMPORTED_MODULE_6__pages_article__["b" /* remove */],
	},
];
...
class Router {
	constructor(){
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).bind("hashchange", () => {
		...
		__WEBPACK_IMPORTED_MODULE_5__pages_sidebar__["a" /* init */]();
	}
	...
	updateView(){
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#page-container > *").hide();
		...
		let elmt = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#page-container").find(this.currentRoute.elmt);
		elmt.show();
		if(this.currentRoute.onInit !== null)
			this.currentRoute.onInit();

		__WEBPACK_IMPORTED_MODULE_5__pages_sidebar__["b" /* updateActiveLinkButtons */]();
...
/* harmony export (immutable) */ __webpack_exports__["c"] = updateState;
/* harmony export (immutable) */ __webpack_exports__["d"] = updateUserSourceList;
/* harmony export (immutable) */ __webpack_exports__["b"] = updateActiveLinkButtons;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__storage__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__matrix__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sources__ = __webpack_require__(2);
...
const sourceButton = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`
...
function updateState(){
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .navbar-if-setup").toggle(__WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].homeserverURL !== null);
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .navbar-if-notsetup").toggle(__WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].homeserverURL === null);

	if(__WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].homeserverURL === null){
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .endpoint-url").text("Not setup");

		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .navbar-if-connected").hide();
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .navbar-if-notconnected").hide();
	}
	else{
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .endpoint-url").text(__WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].homeserverURL);

		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .navbar-if-connected").toggle(__WEBPACK_IMPORTED_MODULE_2__matrix__["d" /* isInformoConnected */]() === true);
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .navbar-if-notconnected").toggle(__WEBPACK_IMPORTED_MODULE_2__matrix__["d" /* isInformoConnected */]() !== true);

		// Connect to informo
		__WEBPACK_IMPORTED_MODULE_2__matrix__["a" /* getConnectedMatrixClient */]()
...
function updateUserSourceList(){


	if(__WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].userSources !== lastSourceList){

		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .informo-source-link").remove();
		let appender = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .sourcelist-append");

		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .sourcelist-load").hide();

		__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar .sourcelist-placeholder").toggle(__WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].userSources.length === 0);

		let i = 0;

		for(let sourceName of __WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].userSources){
			let source = __WEBPACK_IMPORTED_MODULE_3__sources__["a" /* default */].sources[__WEBPACK_IMPORTED_MODULE_4__const__["a" /* newsEventPrefix */] + sourceName];
			...
			if(source){
				...
				li.find(".source-remove").bind("click", () => {
					const sourceIndex = __WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].userSources.indexOf(sourceName);
					if(sourceIndex >= 0){
						__WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].userSources.splice(sourceIndex, 1);
						__WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].save();
		...
		lastSourceList = __WEBPACK_IMPORTED_MODULE_3__sources__["a" /* default */].sources;
	}


}

function updateActiveLinkButtons(){
	const href = window.location.hash;

	__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#sidebar li").each((i, li) => {
		const listItem = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(li);
		const link = listItem.find("> a:first-child");
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()(listItem).toggleClass("active", __WEBPACK_IMPORTED_MODULE_0_jquery___default()(link).attr("href") === href);
	});
}
...
;!function (a, b, c, d) {
  ...
  function k(a, b, c) {
    ...
    } }, n(hc, { INPUT_START: O, INPUT_MOVE: P, INPUT_END: Q, INPUT_CANCEL: R, STATE_POSSIBLE: Rb, STATE_BEGAN: Sb, STATE_CHANGED: Tb, STATE_ENDED: Ub, STATE_RECOGNIZED: Vb, STATE_CANCELLED: Wb, STATE_FAILED: Xb, DIRECTION_NONE: S, DIRECTION_LEFT: T, DIRECTION_RIGHT: U, DIRECTION_UP: V, DIRECTION_DOWN: W, DIRECTION_HORIZONTAL: X, DIRECTION_VERTICAL: Y, DIRECTION_ALL: Z, Manager: kc, Input: ab, TouchAction: Pb, TouchInput: Eb, MouseInput: rb, PointerEventInput: wb, TouchMouseInput: Gb, SingleTouchInput: Ab, Recognizer: Yb, AttrRecognizer: ac, Tap: gc, Pan: bc, Swipe: fc, Pinch: cc, Rotate: ec, Press: dc, on: t, off: u, each: m, merge: o, extend: n, inherit: p, bindFn: q, prefixed: B }), "function" == g && __webpack_require__(15) ? !(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return hc;
...
/* harmony default export */ __webpack_exports__["a"] = (new Database);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__const__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__article_reader__ = __webpack_require__(11);
// Copyright 2018 Informo core team <core@informo.network>
//
// Licensed under the GNU Affero General Public License, Version 3.0
// (the "License"); you may not use this file except in compliance with the
...
const template = [
	{
		...
		`),
		article: __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`
...
class FeedReader {
	...
	constructor(container, compact){
		console.assert(container instanceof __WEBPACK_IMPORTED_MODULE_0_jquery___default.a);
		...
		if(this.compact === true){
			...
			this.articleReader = new __WEBPACK_IMPORTED_MODULE_3__article_reader__["a" /* ArticleReader */](this.body.find(".reader-pane-article"), true, false);

			// TODO: handle unbind
			const body = this.body;
			__WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).bind("resize", function(){
				body.height(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).height() - body.position().top);
			});
			this.body.height(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).height() - this.body.position().top);
	...
	deactivate(){
		...
		if(this.scrollListener !== null){
			__WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).unbind("scroll.readerBottomLoad");
		}
	}
	...
	setFeedNames(sourceNames){
		...
		for(let sourceName of sourceNames){
			sourceClassNames.push(__WEBPACK_IMPORTED_MODULE_2__const__["a" /* newsEventPrefix */] + sourceName);
		}
		this.setFeed(sourceClassNames);
	}
	...
	setFeed(sourceClassNames){
		...
		for(let sourceClassName of sourceClassNames)
			console.assert(sourceClassName.startsWith(__WEBPACK_IMPORTED_MODULE_2__const__["a" /* newsEventPrefix */]), "wrong class prefix for "+sourceClassName);
		...
		this._appendFeedArticles(true, true)
			.then(() => {
				...
				// Bind bottom scroll
				this.scrollPane = this.compact === true ? __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window) : this.body.find(".reader-pane-list .scrollpane");
				if(this.scrollListener !== null){
	...
	_appendFeedArticles(resetPos, reportProgress = false) {
		...
		return __WEBPACK_IMPORTED_MODULE_1__matrix__["a" /* getConnectedMatrixClient */]()
			.then(() => {
				if(reportProgress === true)
					loaderText.text("Fetching news...");

				return __WEBPACK_IMPORTED_MODULE_1__matrix__["b" /* getNews */](this.sourceClassNames, resetPos);
			})
			.then((news) => {
				if (!(news && news.length)) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = FeedReader;
...
const template = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`
...
class ArticleReader {
	...
	constructor(container, showPrevNextButtons, showLoader = true, fixedTopBar = false) {
		...
		this.body.find(".markunread-button").bind("click", (ev) => {
			if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(ev.currentTarget).hasClass("disabled") === false && this.currentArticle !== null){
		...
		this.body.find(".share-button").bind("click", (ev) => {
			if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(ev.currentTarget).hasClass("disabled") && this.currentArticle !== null){
				...
				__WEBPACK_IMPORTED_MODULE_0_jquery___default()(ev.currentTarget).addClass("active");
			}
		});
		...
		this.body.find(".share-button-dropdown .copy-button").bind("click", (ev) => {
			const field = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(ev.currentTarget.parentNode).find("input");
			field.focus();
			field.select();
	...
	fetchContent(eventID){
		...
		__WEBPACK_IMPORTED_MODULE_1__matrix__["a" /* getConnectedMatrixClient */]()
			.then(() => {
				loaderText.text("Fetching article...");
				return __WEBPACK_IMPORTED_MODULE_1__matrix__["c" /* getSingleArticle */](eventID);
			})
			.then((article) => {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ArticleReader;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_materialize_css__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__storage__ = __webpack_require__(3);
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()(document).ready(function(){
	...
	__WEBPACK_IMPORTED_MODULE_1_jquery___default()("#sidebar-button").sideNav({closeOnClick: true, menuWidth: 250});
	__WEBPACK_IMPORTED_MODULE_1_jquery___default()(".modal").modal();

	if(!__WEBPACK_IMPORTED_MODULE_3__storage__["a" /* default */].homeserverURL){
		//Redirect to connect page
		__WEBPACK_IMPORTED_MODULE_5__router__["a" /* default */].navigate("/connect");//TODO: handle post connection redirection
	}
	else
		__WEBPACK_IMPORTED_MODULE_5__router__["a" /* default */].updateView();
});


// TODO: find a better way to make externalLink() global
document.externalLink = function(elmt){
	const modal = __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#external-link-confirm");
	const linkTarget = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(elmt).attr("href");
	...
	__WEBPACK_IMPORTED_MODULE_1_jquery___default()("#external-link-confirm").modal("open");
	return false;
};
...
class MatrixClient {
	static registerGuest(homeserverURL) {
		return new Promise((resolve, reject) => {
			resolve(__WEBPACK_IMPORTED_MODULE_0__ajax__["a" /* req */](
				"POST",
				homeserverURL,
	...
	_requestMessages(roomID, filter, lim) {
		...
		return __WEBPACK_IMPORTED_MODULE_0__ajax__["a" /* req */](
			"GET",
			this.homeserverURL,
...
/* harmony export (immutable) */ __webpack_exports__["a"] = MatrixClient;
...
function req(method, homeserverURL, path, accessToken, body = {}) {
	return new Promise((resolve, reject) => {
		if(accessToken) {
		...
		resolve(__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
			method: method,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sources__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__database__ = __webpack_require__(9);
// Copyright 2017 Informo core team <core@informo.network>
//
// Licensed under the GNU Affero General Public License, Version 3.0
// (the "License"); you may not use this file except in compliance with the
...
class Article {
	...
	setRead(read = true){
		this._isRead = read;
		__WEBPACK_IMPORTED_MODULE_1__database__["a" /* default */].setArticleRead(this.id, read);
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__matrix__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_materialize_css__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_materialize_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_materialize_css__);
...
function init(){
	...
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#form-connect-homeserver-error").text("");


	let homeserverList = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#connect-homeserver-list");
	homeserverList.empty();
	for(let homeserver of homeservers){

		let tr = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`
		...
		tr.bind("click", () => {
			__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#form-connect-homeserver-url")
				.val(homeserver.url);
			__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#form-connect-room-alias")
				.val(homeserver.room);
			__WEBPACK_IMPORTED_MODULE_4_materialize_css___default.a.updateTextFields();
		});
	...
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#form-connect-homeserver").bind("submit", () => {
		let url = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#form-connect-homeserver-url").val();
		let roomAlias = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#form-connect-room-alias").val();

		__WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].homeserverURL = url;
		__WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].roomAlias = roomAlias;
		__WEBPACK_IMPORTED_MODULE_5__sidebar__["c" /* updateState */]();
		__WEBPACK_IMPORTED_MODULE_3__matrix__["a" /* getConnectedMatrixClient */]()
			.then((client) => {
				console.log("Connected to client: ", client);
				//TODO: redirect to /feeds if user has already selected some feeds to follow
				__WEBPACK_IMPORTED_MODULE_5__sidebar__["c" /* updateState */]();
				__WEBPACK_IMPORTED_MODULE_2__router__["a" /* default */].navigate("/discover");
			},
			(err) => {
				console.error("Could not connect to matrix server: ", err);
				__WEBPACK_IMPORTED_MODULE_4_materialize_css___default.a.toast("Error: " + err, 4000, "red darken-3");
			});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__storage__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__router__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__fragments_feed_reader__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__sources__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__const__ = __webpack_require__(4);
// Copyright 2018 Informo core team <core@informo.network>
//
// Licensed under the GNU Affero General Public License, Version 3.0
// (the "License"); you may not use this file except in compliance with the
...
function init(type){
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()("body > .navbar-fixed").hide();//TODO: will make impossible to open the side nav

	if(reader === null){
		reader = new __WEBPACK_IMPORTED_MODULE_3__fragments_feed_reader__["a" /* FeedReader */](__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#page-feeds .feed-reader"), false);
	}
	...
	case "all":
		...
		sources = __WEBPACK_IMPORTED_MODULE_1__storage__["a" /* default */].userSources;
		break;
	case "source":{
		const sourceName = __WEBPACK_IMPORTED_MODULE_2__router__["a" /* default */].getPathParamValue("sourceName");

		//TODO: will display sourceName if informo not yet connected
		const source = __WEBPACK_IMPORTED_MODULE_4__sources__["a" /* default */].sources[__WEBPACK_IMPORTED_MODULE_5__const__["a" /* newsEventPrefix */] + sourceName];
		if(source)
	...
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#page-feeds .page-title").text(title);
	reader.setFeedNames(sources);

}

function remove(){
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()("body > .navbar-fixed").show();
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__const__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__matrix__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fragments_feed_reader__ = __webpack_require__(10);
...
function init(){
	...
	if(reader === null){
		reader = new __WEBPACK_IMPORTED_MODULE_4__fragments_feed_reader__["a" /* FeedReader */](__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .feed-reader"), true);
	}
	else
		reader.reset();

	__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .content-loader").show();
	__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .content").hide();
	__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .content-loader .loader-text").text("Waiting connection to Informo...");

	let sourceName = __WEBPACK_IMPORTED_MODULE_0__router__["a" /* default */].getPathParamValue("sourceName");
	sourceClassName = __WEBPACK_IMPORTED_MODULE_2__const__["a" /* newsEventPrefix */] + sourceName;

	__WEBPACK_IMPORTED_MODULE_3__matrix__["a" /* getConnectedMatrixClient */]()
		.then(() => {
			// TODO: content will be inserted multiple times if we change page during loading
			const source = __WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].sources[sourceClassName];

			if(!source){
				__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .name").text("Unknown source");
				__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .description").text("This source does not exist");

				__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .add-button").hide();
				__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .remove-button").hide();
			}
			else{
				__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .name").text(source.name);
				__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .description").text("This source use the following public key: " + source.publicKey);

				// Display news for this source
				reader.setFeed([sourceClassName]);
			}

			__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .content-loader").hide();
			__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-source .content").show();
...
const tempateCard = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`
...
function init(){
	...
	__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#page-discover ul.tabs").tabs();
	//TODO: bind search fields

	const container = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#page-discover .card-container");

	container.empty();

	__WEBPACK_IMPORTED_MODULE_4__matrix__["a" /* getConnectedMatrixClient */]()
		.then(() => {

			for(let sourceEventClassName in __WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].sources){
				if(sourceEventClassName.startsWith(__WEBPACK_IMPORTED_MODULE_3__const__["a" /* newsEventPrefix */])){
					const source = __WEBPACK_IMPORTED_MODULE_1__sources__["a" /* default */].sources[sourceEventClassName];
					const sourceName = Object(__WEBPACK_IMPORTED_MODULE_3__const__["b" /* stripNewsEventPrefix */])(sourceEventClassName);
					...
					const sourceIndex = __WEBPACK_IMPORTED_MODULE_2__storage__["a" /* default */].userSources.indexOf(sourceName);

					const addButton = card.find(".add-button");
					addButton.toggleClass("disabled", sourceIndex >= 0);

					addButton.bind("click", () => {
						const sourceIndex = __WEBPACK_IMPORTED_MODULE_2__storage__["a" /* default */].userSources.indexOf(sourceEventClassName);
						if(sourceIndex < 0){
							__WEBPACK_IMPORTED_MODULE_2__storage__["a" /* default */].userSources.push(sourceName);
							__WEBPACK_IMPORTED_MODULE_2__storage__["a" /* default */].save();
							__WEBPACK_IMPORTED_MODULE_5__sidebar__["d" /* updateUserSourceList */]();
					...
					console.warn("User sources contains '" + sourceEventClassName + "' that does not match '"+__WEBPACK_IMPORTED_MODULE_3__const__["a" /* newsEventPrefix */]+".*' format");
				}
			}
		});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__const__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__matrix__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fragments_article_reader__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_jquery__);
// Copyright 2018 Informo core team <core@informo.network>
//
...
function init(){
	__WEBPACK_IMPORTED_MODULE_5_jquery___default()("body > .navbar-fixed").hide();//TODO: will make impossible to open the side nav

	if(reader === null){
		reader = new __WEBPACK_IMPORTED_MODULE_4__fragments_article_reader__["a" /* ArticleReader */](__WEBPACK_IMPORTED_MODULE_5_jquery___default()("#page-article"), false, true, true);
	}

	reader.fetchContent(__WEBPACK_IMPORTED_MODULE_0__router__["a" /* default */].getPathParamValue("eventID"));
}

function remove(){
	__WEBPACK_IMPORTED_MODULE_5_jquery___default()("body > .navbar-fixed").show();
}
